...
```
Scaffold-DbContext "Server=.\SQLExpress;Database=DessertDb;Trusted_Connection=True; Encrypt=False;" Microsoft.EntityFrameworkCore.SqlServer -OutputDir Models
```
